...
class MiddayDrugViewController: UIViewController {
    ...
    func installUI() {
        ...
        if today?.midday == 1 {
            let barButtonItem = UIBarButtonItem(title: "", style: UIBarButtonItemStyle.plain, target: self, action: nil)
